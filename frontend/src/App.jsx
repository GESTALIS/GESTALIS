            ...
            <PrivateRoute>
              <Layout>
                <Routes>
                  ...
                  <Route path="/vente" element={<div>Vente & Devis</div>} />
                  <Route path="/commercial" element={<div>Gestion Commerciale</div>} />
                  <Route path="/tresorerie" element={<div>Règlements & Trésorerie</div>} />
                  <Route path="/clients" element={<div>Clients/Fournisseurs</div>} />
