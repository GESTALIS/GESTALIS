# Script PowerShell pour modifier Achats.jsx - Supprimer la fusion localStorage/Supabase
...
$content = $content -replace [regex]::Escape($oldLogic), $newLogic

# Sauvegarder le fichier modifié
Set-Content $filePath $content -Encoding UTF8

Write-Host "✅ Fichier Achats.jsx modifié - Fusion localStorage/Supabase supprimée" -ForegroundColor Green
